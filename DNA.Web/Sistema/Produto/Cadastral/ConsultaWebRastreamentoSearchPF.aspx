<%@ Page Title="" Language="C#" MasterPageFile="~/PrincipalAutenticada.Master" AutoEventWireup="true"
    CodeBehind="ConsultaWebRastreamentoSearchPF.aspx.cs" Inherits="DNA.Web.Sistema.Produto.Cadastral.ConsultaWebRastreamentoSearchPF" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function ValidaCampos() {
            ...
            var dataNascimento = document.getElementById('ctl00_head_txtDataNascimento').value;
            var nomeMae = document.getElementById('ctl00_head_txtNomeMae').value;

            if (document.getElementById('ctl00_head_txtNome').value != '')
            {
                if (strUF != "00" && strCidade != "00") {
                    ShowProgressAnimation();
                    return true;
                }

                if (dataNascimento != '' && nomeMae != '') {
                    ShowProgressAnimation();
                    return true;
                }

                alert('PELO MENOS A DATA DE NASCIMENTO, NOME DA MAE OU UF+MUNICIPIO DEVEM SER INFORMADOS.');
            }
            ...
            <tr>
                <td style="width: 220px;">
                    <asp:Label ID="Label7" runat="server" CssClass="LabelMensagemRetorno"
                        Visible="true" Text="NOME COMPLETO:" Style="font-weight: normal; font-size: 20px;color:#000;"></asp:Label>
                </td>
                <td align="left">
            ...
            <tr>
               ...
               <td align="left"  > 
                    <div id="div0" style="">
                        ...
                        <div id="div2" style="float: left; position:relative; left:-50px; top:0px;" >
            ...
            <tr>
                <td>
                    <asp:Label ID="Label429" runat="server" CssClass="LabelMensagemRetorno"
                        Visible="true" Text="DATA NASCIMENTO:" 
                        Style="font-weight: normal; font-size: 20px;color:#000;"></asp:Label>
                </td>
                <td align="left">
                    <asp:TextBox ID="txtDataNascimento" runat="server" MaxLength="100"
                        Style="color: #000; text-align: center; text-transform: uppercase;
                        font-family: 'Segoe UI', 'Open Sans', Arial, sans-serif; text-decoration: none;
                        font-size: 20px;" Text="" Width="200px"></asp:TextBox>
                    &nbsp;<img id="imgDataNascimento" alt="" onclick="dp_cal1.toggle();" 
                        src="../../../images/calendario.png" style="position: relative; top: 0px; cursor: pointer;
                        left: -35px;" title="Abrir Calendário" /></td>
               <td align="left"  > 
                    &nbsp;</td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label430" runat="server" CssClass="LabelMensagemRetorno"
                        Visible="true" Text="NOME DA MÃE:" 
                        Style="font-weight: normal; font-size: 20px;color:#000;"></asp:Label>
                </td>
                <td align="left">
                    <asp:TextBox ID="txtNomeMae" runat="server" MaxLength="100"
                        Style="color: #000; width: 575px; text-align: left; text-transform: uppercase;
                        font-family: 'Segoe UI', 'Open Sans', Arial, sans-serif; text-decoration: none;
                        font-size: 20px;" Text=""></asp:TextBox>
                </td>
                ...
                <td colspan="2" align="right">
                    <div>
                        <asp:Button Text="Pesquisar" runat="server" ToolTip="Pesquisar..." CssClass="btnPesquisar"
                            ...
                            OnClientClick="return ValidaCampos();" style="margin-right:10px;" />
                    </div>
                </td>
                <td align="right">
                    &nbsp;</td>
