<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="DNA.Web.Home" %>
			...
			<div class="center-sign">
				...
				<div class="panel panel-sign">
					<div class="panel-title-sign mt-xl text-right" >
						<h2 class="title text-uppercase text-bold m-none"><div style="background:url(Images/user.png); background-repeat:no-repeat; width:21px; height:23px;position:relative;margin-left:-10px;float:left"></div>L O G I N</h2>
					</div>
					<div class="panel-body">
							<div class="form-group mb-lg">
								<label>Usuário</label>
								<div class="input-group input-group-icon">
									<input runat="server" id="txtLogin" name="username" type="text" class="form-control input-lg" maxlength="15" style="font-size:18px; text-transform:uppercase;" required="required" title="O seu login é obrigatório." />
									<span class="input-group-addon">
										<span class="icon icon-lg">
											<div style="background:url(Images/user.png); background-repeat:no-repeat; width:21px; height:23px;position:relative;margin-left:-15px;"></div>
										</span>
									</span>
								</div>
							</div>
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input runat="server" id="txtSenha" name="pwd" type="password" class="form-control input-lg" maxlength="20" style="font-size:18px; text-transform:uppercase;" required="required" title="A sua senha é obrigatória." />
									<span class="input-group-addon">
										<span class="icon icon-lg">
											<div style="background:url(Images/cadeado.png); background-repeat:no-repeat; width:21px; height:23px;position:relative;margin-left:-15px;"></div>
										</span>
									</span>
								</div>
							</div>
