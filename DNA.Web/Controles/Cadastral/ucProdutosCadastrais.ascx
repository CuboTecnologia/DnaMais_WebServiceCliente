<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucProdutosCadastrais.ascx.cs" Inherits="DNA.Web.Controles.Cadastral.ucProdutosCadastrais" %>

<div id="divProdutosVeiculares" runat="server" style="">
<div style=" width:96%;" class="divResultadoPesquisaVeiculos">
<label for="lblDescricaoCategoriaProdutos" style="font-weight: normal; font-size: 20px;">Produtos Cadastrais</label>
<hr/>
</div>
