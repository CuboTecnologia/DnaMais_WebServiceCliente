            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        retResponse.DadosCadastrais.Obito = dr["OBITO"].ToString();
                        retResponse.DadosCadastrais.DataObito = dr["DATA_OBITO"].ToString();
                    }
                    ...
                    foreach (DataRow dr in ds.Tables[4].Rows)
                    {
                        ...
                        //qsa.UF = dr["UF"].ToString();
                        //qsa.Cidade = dr["CIDADE"].ToString();
